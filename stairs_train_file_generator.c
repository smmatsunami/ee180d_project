...
int main(int argc, char **argv) {
	...
	double* std_accel_y_seg0;
	double* max_accel_y_seg1;
	double* min_accel_y_seg1;
	double* std_accel_y_seg1;
	double* max_accel_y_seg2;
	double* min_accel_y_seg2;
	double* std_accel_y_seg2;
	double* max_accel_y_seg3;
	double* min_accel_y_seg3;
	double* std_accel_y_seg3;

	double* max_accel_x_seg0;
	double* min_accel_x_seg0;
	double* mean_accel_x_seg0;
	double* max_accel_x_seg1;
	double* min_accel_x_seg1;
	double* mean_accel_x_seg1;
	double* max_accel_x_seg2;
	double* min_accel_x_seg2;
	double* mean_accel_x_seg2;
	double* max_accel_x_seg3;
	double* min_accel_x_seg3;
	double* mean_accel_x_seg3;
	double* period;
	int* pattern;
	...
	for(j = 1; j <= outputNeuronNum; j++){
		...
		if(i == 0){
			...
			std_accel_y_seg0 = (double*) realloc(std_accel_y_seg0, sizeof(double) * N_SAMPLES);
			...
			std_accel_y_seg1 = (double*) realloc(std_accel_y_seg1, sizeof(double) * N_SAMPLES);
			...
			std_accel_y_seg2 = (double*) realloc(std_accel_y_seg2, sizeof(double) * N_SAMPLES);
			...
			std_accel_y_seg3 = (double*) realloc(std_accel_y_seg3, sizeof(double) * N_SAMPLES);

			max_accel_x_seg0 = (double*) realloc(max_accel_x_seg0, sizeof(double) * N_SAMPLES);
			min_accel_x_seg0 = (double*) realloc(min_accel_x_seg0, sizeof(double) * N_SAMPLES);
			mean_accel_x_seg0 = (double*) realloc(mean_accel_x_seg0, sizeof(double) * N_SAMPLES);
			max_accel_x_seg1 = (double*) realloc(max_accel_x_seg1, sizeof(double) * N_SAMPLES);
			min_accel_x_seg1 = (double*) realloc(min_accel_x_seg1, sizeof(double) * N_SAMPLES);
			mean_accel_x_seg1 = (double*) realloc(mean_accel_x_seg1, sizeof(double) * N_SAMPLES);
			max_accel_x_seg2 = (double*) realloc(max_accel_x_seg2, sizeof(double) * N_SAMPLES);
			min_accel_x_seg2 = (double*) realloc(min_accel_x_seg2, sizeof(double) * N_SAMPLES);
			mean_accel_x_seg2 = (double*) realloc(mean_accel_x_seg2, sizeof(double) * N_SAMPLES);
			max_accel_x_seg3 = (double*) realloc(max_accel_x_seg3, sizeof(double) * N_SAMPLES);
			min_accel_x_seg3 = (double*) realloc(min_accel_x_seg3, sizeof(double) * N_SAMPLES);
			mean_accel_x_seg3 = (double*) realloc(mean_accel_x_seg3, sizeof(double) * N_SAMPLES);
		...
		while((read = getline(&line, &len, fp)) != -1){
			...
			rv = sscanf(line, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf\n", 
				&max_accel_y_seg0[i], &min_accel_y_seg0[i], &std_accel_y_seg0[i],
				&max_accel_y_seg1[i], &min_accel_y_seg1[i], &std_accel_y_seg1[i],
				&max_accel_y_seg2[i], &min_accel_y_seg2[i], &std_accel_y_seg2[i],
				&max_accel_y_seg3[i], &min_accel_y_seg3[i], &std_accel_y_seg3[i],
				&max_accel_x_seg0[i], &min_accel_x__seg0[i], &mean_accel_x_seg0[i], 
				&max_accel_x_seg1[i], &min_accel_x__seg1[i], &mean_accel_x_seg1[i], 
				&max_accel_x_seg2[i], &min_accel_x__seg2[i], &mean_accel_x_seg2[i], 
				&max_accel_x_seg3[i], &min_accel_x__seg3[i], &mean_accel_x_seg3[i],  
				&period[i]);
	...
	for(i = 0; i < N_SAMPLES; i++){
		...
		fprintf(fp, "%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf\t%lf%lf%lf%lf%lf%lf%lf%lf%lf\n", 
			max_accel_y_seg0[i], min_accel_y_seg0[i], std_accel_y_seg0[i],
			max_accel_y_seg1[i], min_accel_y_seg1[i], std_accel_y_seg1[i],
			max_accel_y_seg2[i], min_accel_y_seg2[i], std_accel_y_seg2[i],
			max_accel_y_seg3[i], min_accel_y_seg3[i], std_accel_y_seg3[i],
			max_accel_x_seg0[i], min_accel_x_seg0[i], mean_accel_x_seg0[i],
			max_accel_x_seg1[i], min_accel_x_seg1[i], mean_accel_x_seg1[i],
			max_accel_x_seg2[i], min_accel_x_seg2[i], mean_accel_x_seg2[i],
			max_accel_x_seg3[i], min_accel_x_seg3[i], mean_accel_x_seg3[i],
			period[i]);
